...
//		//2.初始化加载配置文件
//		ClientGlobal.init("E:/Workspaces/MyEclipse 2017(2)/taotao-manager-web/src/main/resources/resources/fastdfs.conf");
//		//3.创建trackerClient对象
...
//		//第二个参数：文件的扩展名 不带"."
//		//第三个参数：元数据     
//		String[] upload_file = storageClient.upload_file("C:/Users/11316/Desktop/111.jpg", "jpg", null);
//		//8.打印图片的地址 ，测试访问
...
//		FastDFSClient client = new FastDFSClient("E:/Workspaces/MyEclipse 2017(2)/taotao-manager-web/src/main/resources/resources/fastdfs.conf");
//		String uploadFile = client.uploadFile("C:/Users/11316/Desktop/111.jpg", "jpg");
