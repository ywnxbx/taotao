...
public class SearchServiceImpl implements SearchService {
	...
	public SearchResult search(String queryString, Integer page, Integer rows) throws Exception {
		...
		//2.设置主查询条件
		if(StringUtils.isNotBlank(queryString)){  //当queryString为空时查询所有
		...
		query.setStart((page-1)*rows); //设置起始位置  page-1 * rows
		query.setRows(rows);
		...
		query.setHighlightSimplePre("<em style=\"color:red\">");  //高亮前缀
